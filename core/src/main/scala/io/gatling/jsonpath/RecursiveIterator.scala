...
abstract class RecursiveIterator[T](root: JsonElement[_]) extends AbstractIterator[JsonElement[_]] {

  protected var nextNode: JsonElement[_] = _
  ...
  override def next(): JsonElement[_] =
    if (finished) {
